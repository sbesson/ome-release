...
for x, y in (
        ...
        ("PYTHON33", "artifacts/OMERO.python-@VERSION@-ice33-@BUILD@.zip"),
        ("PYTHON34", "artifacts/OMERO.python-@VERSION@-ice34-@BUILD@.zip"),
        ("PYTHON35", "artifacts/OMERO.python-@VERSION@-ice35-@BUILD@.zip"),
