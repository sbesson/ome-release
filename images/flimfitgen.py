...
for x, y in (
        ("FLIMFIT_50_WIN",
         "artifacts/FLIMFit-@VERSION@-OME-5.0.win.zip"),
        ("FLIMFIT_50_MAC",
         "artifacts/FLIMFit-@VERSION@-OME-5.0.mac.zip"),
        ("FLIMFIT_44_WIN",
          "artifacts/FLIMFit-@VERSION@-OME-4.4.win.zip"),
        ("FLIMFIT_50_MAC",
          "artifacts/FLIMFit-@VERSION@-OME-4.4.mac.zip"),
           ):
