...
for x, y in (
        ...
        ("CPP_OSX108", "artifacts/bioformats-@VERSION@-MacOSX10.8.zip"),
        ("CPP_OSX109", "artifacts/bioformats-@VERSION@-MacOSX10.9.zip"),
        ("CPP_CENTOS65", "artifacts/bioformats-@VERSION@-CentOS6.5.zip"),
